...
<div className="info-row-social-media">
  <div className="info-icon-social-media-container" >
    <a href="https://www.facebook.com/profile.php?id=61574833281398" target="_blank" rel="noopener noreferrer" className="info-icon-social-media-link">
    <Facebook className="info-icon-social-media" color="rgb(59 130 246)" />
    </a>
  </div>
  <div className="info-icon-social-media-container" >
    <a href="https://www.instagram.com/oandodigital" target="_blank" rel="noopener noreferrer" className="info-icon-social-media-link">
    <Instagram className="info-icon-social-media" color="rgb(225 29 72)" />
    </a>
  </div>
  <div className="info-icon-social-media-container" >
    <a href="https://www.linkedin.com/company/o-o-digital-future/about/" target="_blank" rel="noopener noreferrer" className="info-icon-social-media-link">
    <Linkedin className="info-icon-social-media" color="rgb(14 118 168)" />
    </a>
  </div>
  <div className="info-icon-social-media-container" >
      <a href="https://api.whatsapp.com/send?phone=972528743761" target="_blank" rel="noopener noreferrer" className="info-icon-social-media-link">
