...
O&O לקחו את כל הדיגיטל שלנו קדימה, והכפילו את המחזור תוך זמן קצר.
והכי חשוב? מרגיש שהם באמת חלק מהצוות שלי.`,
  },
  {
    text: `לא האמנתי שקמפיינים יכולים באמת לעשות כזה הבדל, אבל מאז שהתחלתי לעבוד עם O&O המחזור שלנו פשוט הוכפל.
